...
# RUN THIS LAST! Will reset the server and interrupt ansible run 
DOCUMENTATION = '''
---
module: ex04_reset_server
short_description: This module resets the iLO server
'''
...
#Main function
def reset_server(redfishobj, bios_password=None):
...
def main():
    ...
    try:
        ...
        raise excp
    if bios_password:
        reset_server(REDFISH_OBJ, bios_password)
    else:
