...
DOCUMENTATION = '''
---
module: set_active_ilo_nic
short_description: This module sets the active iLO NIC
'''

EXAMPLES = '''
- name: Set active iLO NIC
  become: yes
...
#Main function
def set_active_ilo_nic(redfishobj, shared_nic):
...
def main():
    ...
    try:
        ...
        raise excp
    set_active_ilo_nic(REDFISH_OBJ, shared_nic)
