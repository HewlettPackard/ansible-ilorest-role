...
DOCUMENTATION = '''
---
module: ex05_enable_secure_boot
short_description: This module enabled or disabled secure boot, may require bios password
'''
...
#Main function
def enable_secure_boot(redfishobj, secure_boot_enable, bios_password=None):
...
def main():
    ...
    try:
        ...
        raise excp
    if bios_password:
        enable_secure_boot(REDFISH_OBJ, boot_enabled, bios_password)
    else:
        enable_secure_boot(REDFISH_OBJ, boot_enabled)
