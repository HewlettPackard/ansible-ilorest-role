...
DOCUMENTATION = '''
---
module: ex25_clear_ilo_event_log
short_description: Clears the iLO Event Log
'''

EXAMPLES = '''
- name: clear_ilo_event_log
   become: yes
   ex25_clear_ilo_event_log:
     name: "Clears the iLO event log"
     enabled: True
'''
...
#Main function
def clear_ilo_event_log(redfishobj):
...
def main():
    ...
    try:
        ...
        raise excp
    clear_ilo_event_log(REDFISH_OBJ)
