...
DOCUMENTATION = '''
---
module: ex24_clear_iml
short_description: Clears the Integrated Management Log
'''
...
- name: clear_iml
   become: yes
   ex24_clear_iml:
     name: "Clears the Integrated Management Log"
     enabled: True
'''
