...
#Main function
def set_ilo_timezone(redfishobj, olson_timezone):
...
def main():
    module = AnsibleModule(
        argument_spec = dict(
            ...
            olson_timezone = dict(required=True, type='str')
        )
    )
    # Set variables based on vars fed from .yml
    olson_timezone = module.params['olson_timezone']
    ...
    try:
        ...
        raise excp
    set_ilo_timezone(REDFISH_OBJ, olson_timezone)
