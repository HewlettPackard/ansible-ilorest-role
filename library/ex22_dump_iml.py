...
DOCUMENTATION = '''
---
module: ex22_dump_iml
short_description: This module dumps the integrated management log
'''
    ...
    for instance in instances:
        if instance["@odata.id"].endswith("IML/"):
            ...
            for entry in rsp.dict["Members"]:
                ...
                tmp_dict["Members"] = (response.dict["Severity"] + ": Class " + \
...
def main():
    ...
    try:
        ...
        raise excp
    display_dict = dump_iml(REDFISH_OBJ)
