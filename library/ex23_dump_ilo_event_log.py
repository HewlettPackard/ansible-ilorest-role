...
DOCUMENTATION = '''
---
module: ex22_dump_ilo_event_log
short_description: This module dumps the ilo event log
'''
...
#Main function
def dump_ilo_event_log(redfishobj):
    ...
    for instance in instances:
        if instance["@odata.id"].endswith("IEL/"):
            ...
            for entry in rsp.dict["Members"]:
                ...
                tmp_dict["Members"] = response.dict["Message"]
...
def main():
    ...
    try:
        ...
        raise excp
    display_dict = dump_ilo_event_log(REDFISH_OBJ)
